...
def part1(nums: list[list[str]]) -> int:
    ...
    for num in nums:
        ...
        for i in range(start,end+1):
            # print(i)
            if i > 9 and helper(str(i)):
                print(i)
                ans += i
    return ans

parts = input_s.split(",")
final = [p.split("-") for p in parts]
print(part1(final))